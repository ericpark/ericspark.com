...
const Item = styled(Flex)`
  flex-basis: calc(99.9% * 1 / 2 - 0.0rem);
  max-width: calc(99.9% * 1 / 2 - 0.0rem);
  width: calc(99.9% * 1 / 2 - 0.0rem);
  text-align: center;
  position: relative;
...
const GridItem = ({ uid, sizes, alt, title, short }) => (
  <Item flexDirection="column" key={uid} style={{ marginTop: `${0}rem` }}>
    <StyledLink to={uid}>
