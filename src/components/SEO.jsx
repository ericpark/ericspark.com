...
const SEO = props => {
  const { projectNode, projectPath, projectSEO } = props;
  let title;
  let description;
  let image;
  let postURL;
  if (projectSEO) {
    const projectMeta = projectNode.data;
    title = projectMeta.title.text;
    description = projectMeta.short.text;
    image = projectMeta.project_image.localFile.childImageSharp.resize.src;
